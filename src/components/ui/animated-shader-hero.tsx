    ...
    class PointerHandler {
      ...
      constructor(element: HTMLCanvasElement, scale: number) {
        ...
        const map = (x: number, y: number) => 
          [x * this.scale, this.element.height - y * this.scale];
...
const AnimatedShaderHero: React.FC<AnimatedShaderHeroProps> = ({
  ...
  return (
    <div className={`relative w-full min-h-screen overflow-hidden bg-black ${className}`}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-4 py-20">
        {trustBadge && (
              ...
              {trustBadge.icons && (
                <div className="flex">
                  {trustBadge.icons.map((icon, index) => (
                    <span key={index} className="text-accent">{icon}</span>
                  ))}
                </div>
              )}
        ...
        <div className="text-center space-y-6 max-w-6xl mx-auto">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-white via-white to-accent bg-clip-text text-transparent animate-fade-in-up animation-delay-200">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-accent via-white to-white bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
              {headline.line2}
            </h1>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button 
                  ...
                  className="px-8 py-4 bg-accent text-accent-foreground hover:bg-accent/90 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105"
                >
          ...
          <div className="pt-10 animate-fade-in-up animation-delay-800">
            {children}
          </div>
        </div>
      </div>
