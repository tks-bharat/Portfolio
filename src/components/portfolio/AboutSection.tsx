            ...
            <CardContent className="pt-6 space-y-6">
              {summary ? (
                <div className="prose prose-slate max-w-none animate-in fade-in slide-in-from-bottom-2 duration-500">
                  <p className="text-lg leading-relaxed text-card-foreground/90 whitespace-pre-line italic border-l-4 border-accent pl-6">
                    {summary}
                  </p>
                </div>
              ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                <div className="space-y-2">
                  <h4 className="font-bold text-primary uppercase tracking-wider text-xs">Aspirations</h4>
                  <p className="text-sm text-muted-foreground">Building the next generation of intelligent systems that can reason through complex semantic structures and financial markets.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-bold text-primary uppercase tracking-wider text-xs">Personal Interests</h4>
                  <p className="text-sm text-muted-foreground">Beyond tech, I am an avid writer (published poet), musician, and sportsman who values the scenic beauty of nature.</p>
                </div>
              </div>
            </CardContent>
          </Card>
